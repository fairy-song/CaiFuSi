...
start cmd /k "title 财赋思-后端服务 && color 0A && cd /d %SCRIPT_DIR% && python -m backend.run_dev_enhanced"
...
echo  4. 如需检测AI服务状态：node troubleshoot-ai.js
echo.
echo  常见问题请参考"AI服务修复说明.md"文件
echo.
pause 